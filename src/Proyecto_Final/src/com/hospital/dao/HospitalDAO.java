...
public class HospitalDAO {
    ...
    private Connection getConnection() throws SQLException {
        ...
        return DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital_db", "root", "password");
    }
    ...
    public boolean registrarAtencion(Atencion atn, String usuario) throws SQLException {
        ...
        String sqlAtencion = "INSERT INTO Atenciones (id_cita, fecha_atencion, diagnostico, tratamiento, receta) VALUES (?, NOW(), ?, ?, ?)";
    ...
    public List<String> obtenerHistorialClinico(int idPaciente) throws SQLException {
        ...
        String sql = "SELECT c.fecha_cita, a.diagnostico FROM Atenciones a " +
